...
wherever the clone is. Move it later and re-run the installer, it offers to
repoint the links.
...
those directories are there. Tab completion works in a new shell. Re-running it
